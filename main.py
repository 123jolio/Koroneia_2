...
# -----------------------------------------------------------------------------
# Hide Streamlit default menu and header (optional)
# -----------------------------------------------------------------------------
hide_streamlit_style = """
<style>
/* Hide the Streamlit header, main menu, and footer entirely */
...
def run_intro_page():
    ...
    with col_text:
        st.markdown(
            "<h2 style='text-align: center;'>Ποιοτικά χαρακτηριστικά Επιφανειακού Ύδατος σε Λίμνες, Ταμιευτήρες και Ποτάμια με χρήση Εργαλείων Δορυφορικής Τηλεπισκόπησης</h2>", 
            unsafe_allow_html=True
        )
    st.markdown("""
    <div class="card">
      <h4>Εισαγωγή</h4>
      <p>Αυτή η εφαρμογή αναλύει τα ποιοτικά χαρακτηριστικά του επιφανειακού ύδατος χρησιμοποιώντας εργαλεία δορυφορικής τηλεπισκόπησης. Επιλέξτε τις επιθυμητές ρυθμίσεις από το αριστερό μενού και εξερευνήστε τα δεδομένα.</p>
    </div>
    """, unsafe_allow_html=True)
