...
# -----------------------------------------------------------------------------
# Helper: Data Extraction & Image Processing Functions
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Lake Processing – Monthly and Yearly Analysis Grids Only
# -----------------------------------------------------------------------------
def run_lake_processing_app(waterbody: str, index: str):
    with st.container():
        ...
        # Use the full STACK for the grid analysis
        ...
        # Fixed grid over all 12 months in fixed order (starting from March)
        ...
        for idx, m in enumerate(months_in_order):
            ...
            # Instead of showing an info message, leave the tile blank if the month is not selected.
        ...
        with st.expander("Επεξήγηση: Μηνιαία Κατανομή Ημερών σε Εύρος"):
            st.write("Το πλέγμα αυτό έχει 12 θέσεις (3 ανά σειρά) με τη σειρά που ξεκινά από τον Μάρτιο. "
                     "Εάν ένας μήνας δεν έχει επιλεγεί, η αντίστοιχη θέση μένει κενή.")
        ...
        with st.expander("Επεξήγηση: Ετήσια Κατανομή Ημερών σε Εύρος"):
            st.write("Το πλέγμα αυτό εμφανίζει τα έτη που έχουν επιλεγεί. Εάν κάποιο έτος δεν έχει επιλεγεί, η θέση μένει κενή.")
